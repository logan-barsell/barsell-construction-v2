...
const Logo = ({ menuOpen, isMobile }) => {
  return (
    <div className='flex flex-col items-center'>
      ...
      />
      <h1 className='xs:text-2xl xs:pb-0 pt-0  pb-0.5 text-lg leading-normal lg:hidden text-center sm:px-4 px-0'>
        Barsell Construction
      </h1>
    </div>
  );
};
